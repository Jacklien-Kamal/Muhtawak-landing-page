...
function Layout() {
    ...
    return (
     ...
     className={`fixed z-100 cursor-pointer w-10 h-10  md:w-16 md:h-16 flex justify-center items-center   text-6xl  bottom-10 ${isRTL ? 'right-4 md:right-16' : 'left-4 md:left-16'}  bg-gradient-to-r from-primary via-secondary to-third p-1 rounded-full`}>
