export const en = {
  ...
  ourFeatures: {
    ...
    Creator: {
      subheading:
        "Everything you need to grow as a content creator — flexibility, real brand deals, and fair earnings.",
      items: [
        {
          title: "Work Anytime",
          description:
            "Work anytime without fixed hours — full flexibility on your own schedule.",
        },
        {
          title: "Real Opportunities",
          description:
            "Get real opportunities with known brands that match your content style.",
        },
        {
          title: "Earn Per Content",
          description:
            "Earn for every content you create — transparent and fair compensation.",
        },
      ],
    },
    Agency: {
      subheading:
        "Everything your agency needs — fast turnaround, authentic content, and costs that scale with you.",
      items: [
        {
          title: "Fast Delivery",
          description:
            "Fast delivery with the highest quality standards your clients expect.",
        },
        {
          title: "Original Content",
          description:
            "Original content reflecting real product experiences that convert.",
        },
        {
          title: "Competitive Costs",
          description:
            "Competitive costs that fit your budget without compromising quality.",
        },
      ],
    },
  },
